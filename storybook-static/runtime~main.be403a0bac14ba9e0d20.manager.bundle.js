(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      ...
      "." +
      {
        32: "79a8f7dd36c70fb4e815",
        142: "8c33f45b311b26fe8def",
        295: "e564e6a27749837319da",
        551: "312ed9b9bea7f934d17f",
        566: "820cf0adf388efd22d4c",
        691: "be134c49c5d34ed6c87e",
        725: "78a8f0944060d61010b0",
      }[chunkId] +
      ".manager.bundle.js"),
      ...
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (var scripts = document.getElementsByTagName("script"), i = 0; i < scripts.length; i++) {
            var s = scripts[i];
            if (s.getAttribute("src") == url || s.getAttribute("data-webpack") == "minesweeper:" + key) {
              script = s;
              break;
            }
          }
        script ||
          ...
          script.setAttribute("data-webpack", "minesweeper:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (globalThis.webpackChunkminesweeper = globalThis.webpackChunkminesweeper || []);
